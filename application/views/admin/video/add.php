	...
	<div class="col-md-9">
		<div class="panel panel-default margin-b-30">
			...
			<div class="panel-heading">
				<h4 class="panel-title"> Thêm mới video</h4>
			...
			<div class="panel-body" style="display: block;">
				<form role="form" class="form" id="form" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<span class="oneTwo"><input name="intro" placeholder="Giới thiệu" class="form-control" value="<?php echo set_value('intro') ?>"  _autocheck="true" type="text"></span>     
					...
					<div class="form-group">
						...
						<div class="form-group">
							<span class="oneTwo"><input name="link" placeholder="Link" class="form-control" value="<?php echo set_value('link') ?>"  _autocheck="true" type="text"></span>     
