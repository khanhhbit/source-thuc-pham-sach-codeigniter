	...
	<div class="col-md-9">
		<div class="panel panel-default margin-b-30">
			...
			<div class="panel-heading">
				<h4 class="panel-title"> Thêm mới bài viết</h4>
			...
			<div class="panel-body" style="display: block;">
				<form role="form" class="form" id="form" action="<?php echo admin_url('news/add') ?>" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="formRight">
							<textarea name="intro" id="param_intro" _autocheck="true" rows="4" cols="" class="form-control"><?php echo set_value('intro') ?></textarea>
					...
					<div class="form-group">
						...
						<div class="formRight">
							<textarea name="site_title" id="param_site_title" _autocheck="true" rows="4" cols="" class="form-control"><?php echo set_value('site_title') ?></textarea>
					...
					<div class="form-group">
						...
						<div class="formRight">
							<textarea name="meta_desc" id="param_meta_desc" _autocheck="true" rows="4" cols="" class="form-control"><?php echo set_value('meta_desc') ?></textarea>
