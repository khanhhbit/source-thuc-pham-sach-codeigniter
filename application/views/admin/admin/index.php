...
<div class="panel panel-default margin-b-30">
    ...
    <div class="panel-heading">
        ...
        <div style="clear: "></div>
        <h4 class="panel-title">Danh sách admin </h4>
            ...
            <?php foreach($list as $row):?>
                <tr>
                    ...
                    <td class="option">
                        ...
                        <a onclick="return confirm('Bạn có thật sự muốn xóa không');" href="<?php echo admin_url('admin/delete/'.$row->id) ?>" title="Delete" class="tipS">
