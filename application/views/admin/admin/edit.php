	...
	<div class="col-md-9">
		<div class="panel panel-default margin-b-30">
			...
			<div class="panel-heading">
				<h4 class="panel-title"> Cập nhập admin</h4>
			...
			<div class="panel-body" style="display: block;">
				<form role="form" class="form" id="form" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							<span class="oneTwo"><input name="username" placeholder="Username" class="form-control" value="<?php echo $info->username ?>"  _autocheck="true" type="text" disabled></span>     
                    ...
                    <p style="color: red">Chú ý : Nếu cập nhập mật khẩu thì nhập vào trường này không thì bỏ qua</p>
					<div class="form-group">
