	...
	<div class="col-md-9">
		<div class="panel panel-default margin-b-30">
			...
			<div class="panel-heading">
				<h4 class="panel-title"> Cập nhập slider</h4>
				...
				<form role="form" class="form" id="form" action="" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<div class="form-group">
							...
							<img src="<?php echo base_url('upload/slide/'.$info->image_link) ?>" alt="<?php echo $info->image_link ?>" style="width: 69px; height: 29px">   
					...
					<div class="form-group">
						...
						<div class="form-group">
							<input name="link" placeholder="Link" class="form-control" value="<?php echo $info->link ?>" onChange="format_curency(this);" type="text"> 
					...
					<div class="form-group">
						...
						<div class="form-group">
							<span class="oneTwo"><input name="sort_order" placeholder="Thứ tự" class="form-control" value="<?php echo $info->sort_order ?>"  _autocheck="true" type="text"></span>     
