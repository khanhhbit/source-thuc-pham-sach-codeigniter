...
/**
	 ...
	 * @ string 	$date	Ngay thang nam dau vao
	 * @string 	$format	Format cua $date
	 */
	 ...
	 * @ string 	$date (Neu date la %d-%m-%Y thi phai theo forma)
	...
	/**
	 * Lay khoang thoi gian bat dau va ket thuc (tinh ra giay) tu moc thoi gian co dinh
	 * @ string 	$date  va $date2 (Neu date la %d-%m-%Y thi phai theo forma)
	 * @ array($time_start, $time_end)
	 */
